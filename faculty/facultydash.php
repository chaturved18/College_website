...
<html lang="en">
  ...
  <body>
    ...
    <?php 
    $res=mysqli_query($link,"select * from faculty where id='$_SESSION[id]'");
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link active" href="./facultydash.php">
                  <span data-feather="home"></span>
                  Dashboard 
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="Postattendence.php">
                  <span data-feather="file-text"></span>
                  Post attendance
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="allattendence.php">
                  <span data-feather="file-text"></span>
                  view attendance
                </a>
              </li>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0"><?php echo $value['dept'] ?></p>
                        </div>
                      </div>
                      <!-- <hr>
                      <div class="row">
